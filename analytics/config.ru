...
Unreloader = Rack::Unreloader.new(subclasses: %w[Roda Sequel::Model], logger:, reload: dev) { Analytics }
require_relative "models"
Unreloader.require("app.rb") { "Analytics" }
...
run(dev ? Unreloader : Analytics.freeze.app)
